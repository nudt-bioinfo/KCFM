...
def main():
    ...
    p.add_argument("--data_root", type=str, default="/home/lxz/scmamba/gene_pretubation/GEARS/data",
    ...
    p.add_argument("--dataset_path", type=str, default="/home/lxz/scmamba/gene_pretubation/GEARS/data",
    ...
    p.add_argument("--result_dir", type=str, default="/home/lxz/scmamba/gene_pretubation/GEARS/result")

    args = p.parse_args()

    # 0) 基本检查
    gene2go_pkl = os.path.join(args.data_root, "gene2go.pkl")
    #A1BG,，基因 A1BG 具有以下生物学特性（由GO术语描述） GO:0072562 GO:0031093 GO:1904813 GO:0070062 GO:0005576 GO:0034774 GO:0005615 GO:0062023
    ...
    if args.dataset_name is not None:
        ...
        if not os.path.exists(os.path.join(args.dataset_path, "norman.h5ad")): raise FileNotFoundError(f"{args.dataset_path}/norman.h5ad 不存在，请确认路径")
        # 加载/home/lxz/scmamba/gene_pretubation/GEARS/data/norman.h5ad   如果修改需要去pertdata里面修改
